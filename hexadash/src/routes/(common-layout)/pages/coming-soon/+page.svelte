            ...
            <Col lg={12}>
                <div class="bg-white my-30 content-center">
                    <div class="coming-soon text-center">
                        <img class="dark" src="/img/logo dark-pliflat.svg" alt="dark" />
                        <div class="coming-soon__body">
                            <h1>We are coming soon</h1>
                            <p class="subtitle">
                                Embark on a journey beyond precision with Pro Livestock Intelligence, the ultimate livestock management platform designed for the South African farmer. Embrace modernity and step into the future with us. Stay tuned!
                            </p>
                           
                            <form class="form-inline d-flex justify-content-center my-n10 subscribe-bar">
                                <div class="form-group m-10">
                                    <label for="newsletteremail" class="sr-only">name@example.com</label>
                                    <input
                                        type="email"
                                        class="form-control"
                                        id="inputPassword2"
                                ...
                                <Button color="primary" size="lg" class="m-10 text-uppercase px-20"
                                    >Subscribe</Button
                                >
                            </form>
                        </div>
                        <div class="coming-social">
                            <ul class="d-flex justify-content-center">
                                <li>
                                    <a href={'#'} class="bg-facebook rounded-circle"
                                        ><i class="lab la-facebook-f" /></a
                                    >
                                </li>
                                <li>
                                    <a href={'#'} class="bg-twitter rounded-circle"><i class="lab la-twitter" /></a>
                                </li>
                                <li>
                                    <a href={'#'} class="bg-instagram rounded-circle"
                                        ><i class="lab la-instagram" /></a
                                    >
                                </li>
                                <li>
                                    <a href={'#'} class="bg-dark rounded-circle"><i class="lab la-github" /></a>
                                </li>
                            </ul>
                            <p>© 2024 Pro Livestock Intelligence</p>
                        </div>
                    </div>
                </div>
            </Col>
